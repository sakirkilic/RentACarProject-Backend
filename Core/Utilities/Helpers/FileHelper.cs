...
namespace Core.Utilities.Helpers
{
    public class FileHelper
    {
        public static string Add(IFormFile file)
        {
            ...
            //Dosyanın tam yolunu deği mevcut konumu yolluyorum
            return result.updatedPath;
        }
        ...
        public static string Update(string sourcePath, IFormFile file)
        {
            ...
            {
                using (var stream = new FileStream(result.result, FileMode.Create))
                {
                    file.CopyTo(stream);
                }
            }
        ...
        public static (string result, string updatedPath) newPath(IFormFile file)
        {
            ...
            //Dosya yolu ile beraber dosyanın konumunu yollamak istiyorum.
            string updatedPath= $@"Images\{unique}";
